...
/**
 * Represents an encryption operation event for audit logging.
 * 
 * <p>This event captures metadata about an encryption operation including:
 * <ul>
...
public final class EncryptionEvent {
    ...
    private EncryptionEvent(Builder builder) {
    ...
    public static final class Builder {
        ...
        public EncryptionEvent build() {
            return new EncryptionEvent(this);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        EncryptionEvent that = (EncryptionEvent) o;
