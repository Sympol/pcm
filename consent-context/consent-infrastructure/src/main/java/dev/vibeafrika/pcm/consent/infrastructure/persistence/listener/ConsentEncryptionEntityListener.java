package dev.vibeafrika.pcm.consent.infrastructure.persistence.listener;
...
/**
 * JPA entity listener that applies transparent PII encryption to Consent entities.
 *
 ...
 * creating a circular module dependency between {@code consent-infrastructure}
 ...
 *
 * <p>Note: {@link dev.vibeafrika.pcm.consent.infrastructure.persistence.entity.ConsentJpaEntity}
 * currently has no direct PII String fields (consent purpose/scope are not PII).
 * This listener is in place for future PII fields and to demonstrate the
 * bounded context encryption pattern is established for the Consent context.
 */
public class ConsentEncryptionEntityListener {
