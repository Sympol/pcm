package dev.vibeafrika.pcm.preference.infrastructure.persistence.listener;
...
/**
 * JPA entity listener that applies transparent PII encryption to Preference entities.
 *
 ...
 * creating a circular module dependency between {@code preference-infrastructure}
 ...
 *
 * <p>Note: {@link dev.vibeafrika.pcm.preference.infrastructure.persistence.entity.PreferenceJpaEntity}
 * currently has no direct PII String fields (settings are user preferences, not PII).
 * This listener is in place to establish the bounded context encryption pattern for the
 * Preference context and to support future PII fields.
 */
public class PreferenceEncryptionEntityListener {
